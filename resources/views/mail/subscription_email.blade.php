                        ...
                        <tr>
                          ...
                          <td style="line-height:0px;max-width:600px;padding:0 0 15px 0">
                            <table border="0" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                              <tbody>
                                <tr>
                                  <td style="width:100%;text-align:left;height:33px"><img height="33" src="{{ $message->embed(asset('images/mabwe_logo.png')) }}" style="border:0" class="CToWUd" data-bit="iit"></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
