                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $company->name }}" id="first-title-floating"
                                                ...
                                                <select name="company_type_id" id="categorie"
                                                    ...
                                                    @foreach ($companyTypes as $companyType)
                                                        <option value="{{ $companyType->id }}"
                                                            @if ($company->company_type_id == $companyType->id) selected="" @endif>
                                        ...
                                        <div class="col-12">
                                            <fieldset class="form-group mb-0">
                                                ...
                                                <textarea data-length=20 class="form-control char-textarea champ @error('description') is-invalid @enderror"
                                                    id="textarea-counter" rows="5" name="description" placeholder="Text">{{ $company->description }}</textarea>
                                                @error('description')
                                        ...
                                        <div class="col-12">
                                            <fieldset class="form-group mb-0">
                                                ...
                                                <textarea data-length=20 class="form-control char-textarea champ @error('address') is-invalid @enderror"
                                                    id="textarea-counter" rows="5" name="address" placeholder="Adresse">{{ $company->address }}</textarea>
                                                @error('address')
                                                    <small class="text-light-danger">{{ $message }}</small>
                                                @enderror
                                            </fieldset>
                                        ...
                                        <div class="col-12 form-group file-repeater">
                                            ...
                                            <div class="col form-group p-0">
                                                <div class="col-12 d-flex justify-content-end">
                                                    ...
                                                    <button type="submit" class="btn btn-primary mr-1 mb-1">Mettre à
                                                        jour</button>
                                                    <button type="reset"
